                        ...
                        <div class="main__card_info">
                            ...
                            <div class="main__card_item">
                                ...
                                <div class="main__card_tags">
                                    <p v-for="tag in props.hackathon.tags" :key="tag.id">{{ tag.title }}</p>
                                </div>
                            </div>
                            <div class="main__card_item">
                                <div style="width: 24px; height: 24px">
                            ...
                            <div class="main__card_item">
                                <div class="tt" aria-label="Даты проведения" tabindex="0">
                                    <div style="width: 24px; height: 24px">
                                        <svg class="tt__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p>{{ formatDate(props.hackathon.event_start) }} - {{ formatDate(props.hackathon.event_end) }}</p>
                            </div>
                            <div class="main__card_item">
                                <div class="tt" aria-label="Даты выполнения задания" tabindex="0">
                                    <div style="width: 24px; height: 24px">
                                ...
                                <p>{{ formatDate(props.hackathon.work_time_start) }} - {{ formatDate(props.hackathon.work_time_end) }}</p>
                            </div>
                            <div class="main__card_item">
                                <div class="tt" aria-label="Даты выставления оценок" tabindex="0">
                                    <div style="width: 24px; height: 24px">
                                ...
                                <p>{{ formatDate(props.hackathon.evaluation_start) }} - {{ formatDate(props.hackathon.evaluation_end) }}</p>
                            </div>
                            <div class="main__card_item">
                                <div style="width: 24px; height: 24px">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.tt:hover .tooltip,
.tt:hover .tooltipSquare,
.tt:focus-within .tooltip,
.tt:focus-within .tooltipSquare {
    visibility: visible;
    opacity: 1;
