...
watch(
    () => [ sort.value, selected.format1, selected.status,
...
watch(() => langStore.translations,
    () => {
        filterGroups.value = [
            {
                name: 'format1',
                label: langStore.translations.format,
                options: [
                    { label: capitalizeFirstLetter(langStore.translations.online), value: 'online' },
                    { label: capitalizeFirstLetter(langStore.translations.offline), value: 'offline' },
                    { label: capitalizeFirstLetter(langStore.translations.hybrid), value: 'hybrid' },
                ],
            },
            {
                name: 'status',
                label: langStore.translations.status,
                options: [
                    { label: capitalizeFirstLetter(langStore.translations.upcoming), value: 'upcoming' },
                    { label: capitalizeFirstLetter(langStore.translations.ongoing), value: 'ongoing' },
                    { label: capitalizeFirstLetter(langStore.translations.past), value: 'completed' },
                ],
            },
            {
                name: 'participation',
                label: langStore.translations.participation_type,
                options: [
                    { label: capitalizeFirstLetter(langStore.translations.team_type), value: 'team' },
                    { label: capitalizeFirstLetter(langStore.translations.individual_type), value: 'individual' },
                ],
            },
            {
                name: 'direction',
                label: langStore.translations.tags,
                options: props.tags.map(tag => ({
                    label: tag.title,
                    value: tag.slug ?? tag.id,
                })),
    ...
    >
        ...
        <div class="main__search">
            <div class="main__search_container">
                <input v-model="search" class="main__search_input" @input="fetchHackathons" :placeholder="langStore.translations.search" />
        ...
        <div class="main__container" v-if="langStore.translations">
        ...
        <div v-if="menuVisible" class="slide-out-menu">
            <div class="menu-header">
                <h3>{{ capitalizeFirstLetter(langStore.translations.parameters) }}</h3>
