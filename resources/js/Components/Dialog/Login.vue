    ...
    <div v-if="modelValue" class="dialog" style="z-index:2">
        <div class="dialog__container dialog__container_x-small" @click.stop>
            <div class="dialog__header">
                <p>{{ capitalizeFirstLetter(langStore.translations.authorize) }}</p>
            ...
            <div class="dialog__component" style="margin-top: -10px">
                ...
                <input
                    ...
                    type="text"
                    class="dialog__input"
                    :placeholder="capitalizeFirstLetter(langStore.translations.enter_login)"
            ...
            <div class="dialog__component" style="margin-top: -10px">
                ...
                <input
                    ...
                    type="password"
                    class="dialog__input"
                    :placeholder="capitalizeFirstLetter(langStore.translations.enter_password)"
                    @keydown="handleKeyPress"
                >
            </div>
            <div class="dialog__btns">
                ...
                <button
                    ...
                    @click="submit"
                >
                    {{ pending ? capitalizeFirstLetter(langStore.translations.sending) : capitalizeFirstLetter(langStore.translations.authorize) }}
                </button>
            </div>
        </div>
    </div>
