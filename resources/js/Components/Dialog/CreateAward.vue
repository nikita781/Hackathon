<script setup>
import {reactive, watch, onBeforeUnmount, toRaw, onMounted} from 'vue'
    ...
    <div v-if="modelValue" class="dialog" style="z-index:3" @click.self="close">
        <div class="dialog__container dialog__container_small" @click.stop>
            <div class="dialog__header">
                <p>{{ props.initial ? 'Редактировать награду' : capitalizeFirstLetter(langStore.translations.addAward) }}</p>
