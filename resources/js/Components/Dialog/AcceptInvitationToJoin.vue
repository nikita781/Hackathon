    ...
    <div v-if="modelValue" class="dialog" style="z-index:2">
        <div class="dialog__container dialog__container_small" @click.stop>
            <div class="dialog__header">
                <p>Принять приглашение в команду</p>
            ...
            <p class="dialog__text" style="margin-top: -18px">Вас пригласили вступить в команду. Внимательно прочтите правила и условия участия в хакатоне и подтвердите вступление в команду</p>
