<script setup>
import DialogTabMainInfo from '@/Components/Dialog/Tab/MainInfo.vue'
import DialogTabOverview from '@/Components/Dialog/Tab/Overview.vue'
import DialogTabResources from '@/Components/Dialog/Tab/Resources.vue'
    ...
    >
        <div class="dialog__container" @click.stop>
            ...
            <div class="dialog__btns">
                <button type="button" class="main__btn main__btn_white dialog__btn"         @click="close">Отменить</button>
                <button type="button" class="main__btn dialog__btn">Сохранить</button>
            </div>
        </div>
    </div>
</template>
