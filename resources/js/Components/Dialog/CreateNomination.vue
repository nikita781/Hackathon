        ...
        <div class="dialog__container_custom dialog__container_small" @click.stop>
            <div class="dialog__inner" :class="{ 'is-saving': saving }">
                <div class="dialog__header">
                    <p>{{ form.id ? capitalizeFirstLetter(langStore.translations.updateNomination) : capitalizeFirstLetter(langStore.translations.addNomination) }}</p>
                ...
                <div class="dialog__component">
                    ...
                    <input v-model="form.title" class="dialog__input" :placeholder="capitalizeFirstLetter(langStore.translations.enterNominationTitle)">
                </div>

                <div class="dialog__component">
                    <p class="dialog__title">{{ capitalizeFirstLetter(langStore.translations.totalPrize) }}</p>
                    <input v-model="form.prize" class="dialog__input" :placeholder="capitalizeFirstLetter(langStore.translations.enterTotalPrize)">
                </div>
                ...
                <div class="dialog__component" v-for="(p, idx) in form.prizes" :key="idx">
                    ...
                    <input v-model="form.prizes[idx]" class="dialog__input" :placeholder="capitalizeFirstLetter(langStore.translations.enterWinnerPrize)">
                </div>
