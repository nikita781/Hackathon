        ...
        <div class="dialog__container_custom dialog__container_small" @click.stop>
            <div class="dialog__inner" :class="{ 'is-saving': saving }">
                <div class="dialog__header">
                    <p>{{ form.id ? capitalizeFirstLetter(langStore.translations.edit_nomination) : capitalizeFirstLetter(langStore.translations.addNomination) }}</p>
                ...
                <ConfirmDialog
                    ...
                    :text="capitalizeFirstLetter(langStore.translations.prizes_delete_warning)"
                    @confirm="onConfirm"
                    @cancel="onCancel"
                />
            </div>
