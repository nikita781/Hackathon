    ...
    <div v-if="modelValue" class="dialog" style="z-index:3">
        <div class="dialog__container dialog__container_small" @click.stop>
            <div class="dialog__header">
                <p>{{ props.initial ? capitalizeFirstLetter(langStore.translations.edit_contact) : capitalizeFirstLetter(langStore.translations.add_contact) }}</p>
            ...
            <div class="dialog__component">
                <div class="dialog__title_container">
                    ...
                    <div class="help-tt" aria-label="help">
                        ...
                        <div class="tooltip">
                            <p>{{ capitalizeFirstLetter(langStore.translations.contact_title_hint) }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="dialog__component">
                <div class="dialog__title_container">
                    ...
                    <div class="help-tt" aria-label="help">
                        ...
                        <div class="tooltipSquare"></div>
                        <div class="tooltip">
                            <p>{{ capitalizeFirstLetter(langStore.translations.contact_value_hint) }}</p>
                        </div>
                    </div>
                </div>
