        ...
        <div class="hackathon__gallery">
            ...
            <div class="main__container" v-if="langStore.translations" style="padding: 0; margin: 0">
                ...
                <div class="main__cards">
                    <p class="hackathon__participants_text">Всего: 1685</p>
                    <div class="hackathon__participants_container">
                        <div class="hackathon__participants_item">
                            <p class="hackathon__participants_title">EduGame</p>
