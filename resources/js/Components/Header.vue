...
function handleMenuEnter ()  { overMenu.value = true  }
function handleMenuLeave () {
    overMenu.value = false
    tryClose()
}
function handleHeaderEnter () { overHeader.value = true }
    ...
    <header class="header" @mouseenter="handleHeaderEnter" @mouseleave="handleHeaderLeave">
        <div class="header__container">
            ...
            <div class="header__content">
                <a href="/my-hackathons" class="header__link" :class="{ active: isActiveMyHackathons }" v-if="isAuthenticated">Мои хакатоны</a>
                <div class="header__btns" v-else>
                    <a href="/login" class="main__btn">Войти</a>
                    <a href="#" class="main__btn main__btn_white" style="color: white !important">Регистрация</a>
                </div>
                <div class="header__btns_phone" v-if="isAuthenticated">
                    ...
                    <div class="header__profile" @mouseenter="handleAvatarEnter">
                        ...
                        <div class="header__profile_menu"
                            ...
                            <a href="/profile" class="header__profile_menu_item">Профиль</a>
                            <a @click.prevent="logout" class="header__profile_menu_item">Выйти</a>
                        </div>
                    </div>
                </div>
            </div>
