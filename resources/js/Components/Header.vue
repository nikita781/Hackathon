                    ...
                    <div class="header__content">
                        ...
                        <div class="header__btns_phone" v-if="isAuthenticated">
                            <a href="/notification" class="header__notification">
                                ...
                                <span v-if="props.notifications?.unread" class="header__notification_active"></span>
                            </a>
                            <div class="header__profile" @mouseenter="handleAvatarEnter">
                                <img :src="avatarSrc(props.auth.user.photo)" @error="imgFallback" alt="Profile" class="header__profile_img"/>
