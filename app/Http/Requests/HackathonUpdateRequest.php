...
class HackathonUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'min_team_size' => ['nullable', 'integer', 'min:1', 'lte:max_team_size', 'exclude_if:type,individual'],
            'max_team_size' => ['nullable', 'integer', 'min:1', 'gte:min_team_size', 'exclude_if:type,individual'],
